...
def main() -> None:
    ...
    census_cmd.add_argument("--target-file", help="optional JSON file of K(d,m) research targets to track")
    ...
    if args.command == "self-test":
        ...
        targets = load_kernel_census_targets(args.target_file) if args.target_file else []
        targets.extend(args.target_dm)
        ...
        if args.out_md:
            print(f"wrote Markdown kernel census: {args.out_md}")
